...
#            print i
            captcha="".join(i)
#            print "#####"+captcha
            file_name=os.path.join(img_dir,"%s.png"%(captcha))
            #file_name = os.path.join(img_dir, "%s.png" % (captcha))
            print file_name
...
if __name__=="__main__":
    ...
    parse.add_argument("-n",default=1,type=int,help="n groups of captcha permutations")
    parse.add_argument("-t",default=0.2,type=float,help="ratio of n_test_groups/n_train_groups")
    parse.add_argument("-npi",default=4,type=int,help="num of char per captcha image")
